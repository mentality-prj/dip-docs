...
- KPI: trust uplift >= +10% vs no-explanation cohort.
- KPI: explanation comprehension >= 80% correct interpretation.
- KPI: severe explainability safety incidents = 0.
- Acceptance: reviewer-ready validation dossier.
